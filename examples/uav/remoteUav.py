...
def myNetwork():
    ...
    ap1 = net.addAccessPoint('ap1', cls=OVSKernelAP, ssid='rrh1-ssid',
                             channel='1', mode='g', position='52.0,445.0,0', protocols = 'OpenFlow13')
    ap2 = net.addAccessPoint('ap2', cls=OVSKernelAP, ssid='rrh2-ssid',
                             channel='1', mode='g', position='335.0,435.0,0', protocols = 'OpenFlow13')
    ap3 = net.addAccessPoint('ap3', cls=OVSKernelAP, ssid='rrh3-ssid',
                             channel='1', mode='g', position='583.0,445.0,0', protocols = 'OpenFlow13')
    ap4 = net.addAccessPoint('ap4', cls=OVSKernelAP, ssid='rrh4-ssid',
