...
from mininet.node import RemoteController, CPULimitedHost, Host, UserSwitch
from mininet.log import setLogLevel, info
from mn_wifi.net import Mininet_wifi
from mn_wifi.node import Station, UserAP
...
def myNetwork():
    ...
    s1 = net.addSwitch('s1', cls=UserSwitch, dpid="000000000001", protocols='OpenFlow13')
    s2 = net.addSwitch('s2', cls=UserSwitch, dpid="000000000002", protocols='OpenFlow13')
    s3 = net.addSwitch('s3', cls=UserSwitch, dpid="000000000003", protocols='OpenFlow13')
    ap1 = net.addSwitch('ap1', cls=UserAP, dpid="000000000004", protocols='OpenFlow13')
    ap2 = net.addSwitch('ap2', cls=UserAP, dpid="000000000005", protocols='OpenFlow13')
    ap3 = net.addSwitch('ap3', cls=UserAP, dpid="000000000006", protocols='OpenFlow13')
    ap4 = net.addSwitch('ap4', cls=UserAP, dpid="000000000007", protocols='OpenFlow13')
